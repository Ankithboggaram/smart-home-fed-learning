...
def preprocess_data(
    ...
    filePathPreProcessed = os.path.join(
        output_dir, "SmartHomeDataset-Pre-Processed.csv"
    )
    df.to_csv(filePathPreProcessed)


def split_train_test(
    input_csv: str, frac: float = 0.95, output_dir: str = "data/"
) -> None:
    """
    ...
    df = pl.read_csv(
        ...
        schema_overrides={"time": pl.Utf8, "cloudCover": pl.Utf8},
    )
...
def split_csv_round_robin(
    input_csv: str, num_splits: int = 5, output_folder: str = "data/split_data"
) -> None:
    """
...
if __name__ == "__main__":
    ...
    split_train_test(
        "data/SmartHomeDataset-Pre-Processed.csv", frac=0.95, output_dir="data/"
    )
